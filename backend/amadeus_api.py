...
async def get_flights(origin: str = "BKK", destination:str= "SFO", departure_date:str = '2025-12-24') -> list[dict]:
    """
...
def parse_flight(flight_data: dict) -> dict:
    ...
    flight['currency'] = flight_data['price']['currency']
